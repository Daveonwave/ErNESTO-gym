...
class MicroGridEnvDifferentAction(Env):
    ...
    def __init__(self,
        ...
        self.action_space = Box(low=0., high=1., dtype=np.float32, shape=(1,))     #CHANGED
    ...
    def step(self, action: np.ndarray):
        ...
        # if action[0] >= 0:
        #     i_to_apply = action[0] * i_max
        # else:
        #     i_to_apply = -action[0] * i_min
        #
        # if i_to_apply > i_max:
        #     i_to_apply = i_max
        # elif i_to_apply < i_min:
        #     i_to_apply = i_min



        i_to_apply = i_min + (i_max - i_min) * action[0]
