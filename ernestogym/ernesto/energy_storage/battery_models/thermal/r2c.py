from ernestogym.ernesto.energy_storage.battery_models.generic_models import ThermalModel
from ernestogym.ernesto.energy_storage.battery_models.parameters import Scalar, instantiate_variables
