...
class BatteryEnergyStorageSystemPhyDriven:
    """
    Class representing the physical battery.
    """
    def __init__(self,
                 models_config: list,
    ...
    def get_v(self):
        try:
            ...
            return self._electrical_model.get_first_v()

    def get_i(self):
        try:
            return self._electrical_model.get_i_series(k=-1)
        except:
            return self._electrical_model.get_first_i()
        
    def get_p(self):
        try:
            return self._electrical_model.get_p_series(k=-1)
        except:
            return self._electrical_model.get_first_p()
